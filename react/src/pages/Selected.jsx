...
export const Selected = () => {
    ...
    axios.get('/tracks', { withCredentials: true })
      .then(response => {
        ...
        playlistTrackIdArray.forEach(value => {
          playlistTagArray += `<iframe id="${value} class="px-4" style="border-radius:12px" width="240" height="160"
  ...
  return (
    <div id="main" className="sm:w-full md:w-1/3 mx-auto">
      ...
      <div id="playlist_result" className="w-3/4 my-8 mx-auto flex flex-col align-center"></div>
