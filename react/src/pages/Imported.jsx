...
export const Imported = () => {
  ...
  return (
    <div id="main" className="sm:w-full md:w-1/3 mx-auto flex flex-col items-center">
      ...
      <div className="bg-green-500 rounded-lg w-48">
        <a id="tweet" className=" py-2 px-4" target="_blank" rel="noopener noreferrer">結果をツイート</a><br/>
      </div>
      <div className="bg-green-500 rounded-lg w-48 mt-6">
        <a href="/" className="py-2 px-4">トップへ戻る</a>
      </div>
    </div>
  );
};