...
export const Imported = () => {
  ...
  return (
    <div id="main" className="sm:w-full md:w-1/3 mx-auto">
      ...
      <a id="tweet" className="bg-green-500 rounded-lg block w-48 h-8 py-2" target="_blank" rel="noopener noreferrer">結果をツイート</a><br/>
      <div className="w-full h-12"></div>
      <a href="/" className="bg-green-500 rounded-lg block w-48 h-8 py-2">トップへ戻る</a>
    </div>
  );
};